  ...
  <div className="bg-white px-8 py-4">
    ...
    <ul className="space-y-4 text-gray-600">
      ...
      <li className="flex items-start gap-2">
        <span className="text-blue-500">📄</span>
        <span>
          <code className="font-medium font-mono">src/app/sign-copilot/page.tsx</code> - 
          Sign Copilot: Real-time hand gesture recognition
        </span>
      </li>
      <li className="flex items-start gap-2">
        <span className="text-blue-500">📄</span>
          ...
          <div className="bg-white px-8 py-4">
            ...
            <ApiKeyCheck>
              <div className="flex gap-4 flex-wrap">
                ...
                <a
                  href="/sign-copilot"
                  className="px-6 py-3 rounded-md font-medium shadow-sm transition-colors text-lg mt-4 bg-[#7F7FFF] hover:bg-[#6b6bff] text-white"
                >
                  Sign Copilot →
                </a>
              </div>
